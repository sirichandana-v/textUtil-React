    ...
    return (
        <div className="container" style={myStyle}>
            <div className="accordion" id="accordionExample" style={myStyle}>
                <button type="button" className="btn btn-primary my-1" id="btnDarkMode" onClick={toggleStyle}style={btnStyle}>{btnText}</button>
                <h2 className="my-2" style={myStyle}>About us</h2>
